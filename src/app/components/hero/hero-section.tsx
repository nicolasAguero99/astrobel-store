  ...
  return (
    <div className="flex max-tablet:flex-col-reverse justify-between items-end gap-20 tablet:gap-4 mx-6">
      ...
      <div className='tablet:flex-1 tablet:w-1/2 px-0 miniMobile:px-8 tablet:px-0 max-tablet:mx-auto max-tablet:relative mobile:top-16 max-tablet:top-10 flex flex-col gap-6 max-tablet:items-center max-tablet:text-center'>
        <h1 className='text-4xl min-[580px]:text-5xl xl:text-6xl font-bold leading-snug'>Conoce tu <span className='custom-hero-text'>energía</span> astral</h1>
        <p className='text-lg min-[580px]:text-xl xl:text-2xl font-medium tablet:w-3/4 text-pretty'>Explora los misterios del cosmos y descubre la energía oculta que guía tu destino</p>
