...
export default function Id({ params }: { params: { id: string } }) {
  ...
  return (
    <>
      <Nav />
      <main className="flex max-w-[1200px] max-[780px]:flex-col h-screen mx-auto px-10 min-[420px]:px-16 lg:px-28 min-[420px]:gap-y-16 gap-x-28 justify-center items-center custom-bg">
        ...
        <div className='max-[300px]:hidden relative w-[150px] min-[420px]:w-[200px] tablet:w-[250px] lg:w-[350px] h-[250px] tablet:h-[350px] lg:h-[480px] xl:h-[450px] mt-16 astral-card'>
          <img className='absolute top-0 left-0 drop-shadow-2xl custom-single-front-card' src={`/images/${image}`} alt={name} />
          <img className='absolute top-0.5 -left-0.5 drop-shadow-2xl custom-single-back-card' src={`/images/card-dorsal.png`} alt='carta astral dorsal' />
        </div>
        <div className="w-full min-[780px]:w-1/2 xl:w-fit flex flex-col gap-6">
